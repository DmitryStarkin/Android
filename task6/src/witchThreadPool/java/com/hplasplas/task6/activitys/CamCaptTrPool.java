...
import com.hplasplas.task6.util.BitmapLoadersThreadFactory;
...
public class CamCaptTrPool extends AppCompatActivity implements View.OnClickListener, BitmapInThreadLoader.BitmapLoaderListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myThreadPoolExecutor = new ThreadPoolExecutor(availablePossessors, POSSESSORS_MULTIPLIER * availablePossessors,
                THREAD_IDLE_TIME, TIME_UNIT, new LinkedBlockingQueue<Runnable>(), new BitmapLoadersThreadFactory());
        
        Bundle bundle = new Bundle();
        bundle.putString(FILE_NAME_TO_LOAD, myCurrentPictureFile.getPath());
        bundle.putInt(LIST_INDEX, MAIN_PICTURE_INDEX);
        ...
        myThreadPoolExecutor.execute(new BitmapInThreadLoader(this, bundle));
    }
